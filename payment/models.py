...
class ShippingAddress(models.Model):
  ...
  shipping_postal_code = models.CharField(max_length=7, null=True, blank=True)
...
# Create user Shipping Address by default when user registers (negates checking in store views.py)
