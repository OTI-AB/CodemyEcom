...
class UserInfoForm(forms.ModelForm):
	...
	address1 = forms.CharField(label='', widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Address Lin 1'}), required=False)
	...
	class Meta:
		model = Profile
		fields = ('phone', 'address1', 'address2', 'city', 'province', 'country', 'postal_code',)
